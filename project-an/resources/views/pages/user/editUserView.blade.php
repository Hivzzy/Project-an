...
@section('content')
    <style>
        * {
        ...
        .formbold-form-input:focus {
            border-color: rgba(8, 57, 110, 0.623);
        ...
        .formbold-form-header {
            background: rgba(8, 57, 110, 0.623);
            display: flex;
            align-items: center;
            ...
            <div class="formbold-main-wrapper">
                ...
                <div class="w-full">
                    <div class="formbold-form-wrapper active">
                        ...
                        <form action="/akun/edit/{{ $user->id }}" method="POST" class="formbold-chatbox-form">
                            @csrf
                            ...
                            <div>
                                <button type="input" class="formbold-btn w-full" value="Simpan Data">Submit</button>
                            </div>
                        </form>
                    </div>
                    <div class="formbold-action-buttons active">
    ...
    <script>
        ...
        function chatboxToogleHandler() {
            formWrapper.classList.toggle("");
            formActionButton.classList.toggle("");
        }
    </script>
@endsection
